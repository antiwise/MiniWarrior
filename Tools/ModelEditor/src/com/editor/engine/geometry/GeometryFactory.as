		...
		public function build ( attribute : DynamicAttributeVO , vo : SceneGeometryVO ) : SceneGeometryVO
		{
			...
			switch ( attribute.value )
			{
				...
				case GeometryType.CONE :
				{
					...
					cone.height = s ;
					cone.radius = s ;
					cone.material = vo.material as ColorMaterial ;
				...
				case GeometryType.CUBE :
				{
					...
					/*var materialsData : SkyBoxMaterial = new SkyBoxMaterial ( ) ;
					
					materialsData.cubeMap. = vo.material as SkyBoxMaterial ;
					materialsData.bottom = vo.material as SkyBoxMaterial ;
					materialsData.front = vo.material as SkyBoxMaterial ;
					materialsData.left = vo.material as SkyBoxMaterial ;
					materialsData.right = vo.material as SkyBoxMaterial ;
					materialsData.top = vo.material as SkyBoxMaterial ;
				...
				case GeometryType.CYLINDER :
				{
					...
					cylinder.height = s ;
					cylinder.material = vo.material as ColorMaterial ;
				...
				case GeometryType.SPHERE :
				{
					...
					sphere.radius = s ;
					sphere.material = vo.material as ColorMaterial ;
