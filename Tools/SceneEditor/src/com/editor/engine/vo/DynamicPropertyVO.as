package com.editor.engine.vo
{
	...
	import com.editor.engine.interfaces.IPropertySerializer;

	
	public class DynamicPropertyVO implements IValueObject, IPropertySerializer
	{
		...
		public function DynamicPropertyVO ( )
		{
		}
		 ...
		 */
		public function decodeValue(valueXML:XML):void
		{
			this.key = valueXML.@key;
			this.value = valueXML.@value;
		}
		 ...
		 * @param pro the value of the pro model
		 */
		public function encodeValue():XML
		{
