package com.editor.ui.views.menuview
{
	...
	public class MenuView extends JPanel
	{
		...
		private function onObjDataFetched( data:SceneGeometryVO ):void {
			SceneBuilder.instance.importSceneGeometryVO(data);
		//	AssetsStore.instance.getLoadedModel(data.mesh);
		}
		private function createFileMenu():JMenu {
			...
			file0.addEventListener( AWEvent.ACT, function( event:AWEvent ):void {
				...
				prompt.completeSignal.add( onObjDataFetched );
			});
			...
			////	var prompt:MeshWriter = new MeshWriter(AssetsStore.instance.model.mesh);
			//});
